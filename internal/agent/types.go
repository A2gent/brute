...
const (
	...
	metadataLastLLMRequestAt               = "last_llm_request_at"
	metadataLastLLMProvider                = "last_llm_provider"
	metadataLastLLMModel                   = "last_llm_model"
	metadataLastLLMInputTokens             = "last_llm_input_tokens"
	metadataLastLLMCachedInputTokens       = "last_llm_cached_input_tokens"
