...
func (s *Server) registerSessionRoutes(r chi.Router) {
	...
	r.Route("/sessions", func(r chi.Router) {
		...
		r.Put("/{sessionID}/messages/{messageID}", s.handleUpdateQueuedSessionMessage)
...
func (s *Server) registerProjectRoutes(r chi.Router) {
	...
	r.Route("/projects", func(r chi.Router) {
		...
		r.Get("/git/code-review", s.handleGetProjectCodeReview)
		...
		r.Post("/tests/branch-cache/refresh/stream", s.handleProjectTestsBranchCacheRefreshStream)
		r.Post("/tests/run", s.handleProjectTestsRun)
		r.Post("/tests/run/stream", s.handleProjectTestsRunStream)
		...
		r.Post("/git/code-review/replies", s.handleReplyProjectCodeReview)
